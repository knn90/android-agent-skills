# Refactor candidates — Kotlin

> Reference for [`android-tdd`](../SKILL.md). Kotlin-native rewrite of mattpocock/skills `tdd/refactoring.md` (MIT).
...
| **Primitive obsession** (`String`/`Int` carrying domain meaning) | Introduce a value type — `value class Email`, `enum class Status`, a typed id |
...
- For SOLID/value-object/deep-module judgement calls, defer to `android-solid-expert`; for Compose-specific
  restructuring, `android-compose-expert`.
