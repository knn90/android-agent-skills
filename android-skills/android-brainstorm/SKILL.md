...
description: "Brainstorm solutions for an Android app. Use for ideation, architecture decisions, or feasibility checks. Does NOT implement — hands off to wayfinder."
